...
public class ManagerMaterial {
    ...
    public void crateMaterial() {
        ...
        materials.add(new CrispyFlour("BCG2023", "BCG VM", LocalDate.of(2021, 4, 10), 35000, 10));
    ...
    public void displayRealMoney() {
        String nameMaterialDiscount = scanner.nextLine();
        for (Material material : materials) {
            if (material.getName().equals(nameMaterialDiscount)) {
                if (material instanceof CrispyFlour) {
                    System.out.println("Amount crispyFlour no discount yet: " + material.getAmount());
                    System.out.println("Amount crispyFlour discounted: " + ((CrispyFlour) material).getRealMoney());
                }
                else if (material instanceof Meat) {
                    System.out.println("Amount meat no discount yet: " + material.getAmount());
                    System.out.println( "Amount meat discounted: " + ((Meat) material).getRealMoney());
                }
            }
        }
    }
